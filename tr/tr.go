...
var strs = map[string]map[string]string{
	"en": {
		...
		"ssl_force_desc":          "Enable/Disable forcing HTTP to redirect to HTTPS",
		"ssl_force_args":          "[DOMAIN] [TRUE/FALSE]",
		...
		"cert_enter_force_https":                  "Enable Force SSL?",
		"cert_force_https_enabled":                "Successfully enabled forcing HTTPS for the domain \"%s\"",
		"cert_force_https_disabled":               "Successfully disabled forcing HTTPS for the domain \"%s\"",
		"cert_cannot_force_https_disabled_domain": "You cannot enable/disable forcing https for disabled domain name",
	},
}
