...
var strs = map[string]map[string]string{
	"en": {
		...
		"published_but_no_domains":   "Project \"%s\" has been published to on PubStorm Cloud, but you have no domain names pointing to it. To add a domain name, run `storm domains add`",
		"published_multiple_domains": "Your project has been published on PubStorm Cloud on these domains:",
		...
		"default_domain_already_added":   "Default domain \"%s\" has already been enabled, nothing to do.",
		...
		"default_domain_already_removed": "Default domain \"%s\" has already been removed, nothing to do.",
