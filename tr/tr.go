...
var strs = map[string]map[string]string{
	"en": {
		...
		"ssl_enable_desc":         "Enable SSL/HTTPS on a domain. A free SSL certificate from Let's Encrypt will be used.",
		"ssl_enable_args":         "[DOMAIN]",
		...
		"ssl_enable_progress":    "Setting up SSL for %s...",
		"ssl_enable_error":       "There was a problem requesting for a certificate for \"%s\".",
		"ssl_enable_dns":         "If you haven't already done so, please add the following records to the DNS configuration for the domain \"%s\":",
		"ssl_enable_success":     "SSL/HTTPS has been enabled on %s.",
